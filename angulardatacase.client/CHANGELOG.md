...
- Create Angular project with ng: `ng new angulardatacase.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angulardatacase.client.esproj`).
